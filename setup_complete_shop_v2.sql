...
-- ========================================
-- 1. CREATE TENANT (Shop/Company) - if table exists
-- ========================================
-- Check if tenants table exists and insert if it does
...
-- ========================================
INSERT INTO products (id, tenant_id, name, description, price, category, brand, color, material, sku, barcode, stock_quantity, status, created_at, updated_at)
VALUES
...
-- ========================================
SELECT '========================================' as Result;
SELECT 'SETUP COMPLETE - Fashion Boutique Shop!' as Result;
SELECT '========================================' as Result;

SELECT 'Admin:' as Info;
SELECT email, first_name, last_name, 'admin123' as password FROM tenant_admins;

SELECT 'Products (5 items):' as Info;
SELECT name, price, brand, stock_quantity FROM products ORDER BY name;

SELECT 'Customers (3 people):' as Info;
SELECT email, first_name, last_name, 'customer123' as password FROM users WHERE user_type = 'CUSTOMER' ORDER BY first_name;
